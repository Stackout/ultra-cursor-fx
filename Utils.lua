...
function addon:ExportSettings()
    local exportData = {}
    local fields = {
        "enabled", "flashEnabled", "points", "size", "glowSize", "smoothness",
        "pulseSpeed", "rainbowMode", "rainbowSpeed", "clickEffects",
        "clickParticles", "clickSize", "clickDuration", "particleShape",
        "cometMode", "cometLength", "color",
    }
...
function addon:ImportSettings(importString)
    ...
    local typeMap = {
        enabled = "boolean", flashEnabled = "boolean", points = "number",
        size = "number", glowSize = "number", smoothness = "number",
        pulseSpeed = "number", rainbowMode = "boolean", rainbowSpeed = "number",
        clickEffects = "boolean", clickParticles = "number", clickSize = "number",
        clickDuration = "number", particleShape = "string", cometMode = "boolean",
        cometLength = "number", color = "table",
    }

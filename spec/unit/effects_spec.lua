...
describe("Effects Module", function()
    ...
    describe("Rainbow Mode", function()
        ...
        it("should update particle colors in rainbow mode", function()
            ...
            local changed = UltraCursorFXDB.color[1] ~= initialColor[1] or
                          UltraCursorFXDB.color[2] ~= initialColor[2] or
                          UltraCursorFXDB.color[3] ~= initialColor[3]
    ...
    describe("Click Effects", function()
        ...
        it("should update click particles", function()
            ...
            p.velocityX = 100
            p.velocityY = 100
            p.GetCenter = function() return 100, 100 end

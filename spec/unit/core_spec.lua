...
describe("Core Module", function()
    ...
    describe("Defaults", function()
        it("should have all required default settings", function()
            ...
            assert.are.same({ 0.765, 0.0, 1.0 }, addon.defaults.color)
            assert.are.equal(39, addon.defaults.points)
            assert.are.equal(40, addon.defaults.size)
            assert.are.equal(150, addon.defaults.glowSize)
    ...
    describe("InitializeDefaults", function()
        it("should apply defaults to empty DB", function()
            ...
            assert.are.equal(39, _G.UltraCursorFXDB.account.points)

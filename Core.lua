...
addon.defaults = {
    ...
    -- Spell Tracker System
    spellTrackerEnabled = false,
    spellTrackerCombatOnly = false,
    trackedSpells = {},
    spellTrackerIconSize = 32,
    spellTrackerSpacing = 2,
    spellTrackerOffsetX = 10,
    spellTrackerOffsetY = 30,
...
addon.profileDefaults = {
    ...
    raid = {
        ...
        spellTrackerCombatOnly = true,
        trackedSpells = {},
        spellTrackerIconSize = 36,
        spellTrackerSpacing = 3,
        spellTrackerOffsetX = 10,
        spellTrackerOffsetY = 35,
    },
    dungeon = {
        name = "Dungeon",
        color = { 0.8, 0.2, 1.0 },
